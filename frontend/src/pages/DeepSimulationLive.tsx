      ...
      <header className="sticky top-0 z-20 border-b border-border/80 bg-background/80 backdrop-blur-md">
        <div className="container max-w-7xl py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl leading-none text-foreground">Strategy Arena</h1>
              <p className="text-xs uppercase tracking-[0.22em] text-muted-foreground">Tycoon + Crisis Sprint</p>
            </div>
          </div>
...
export default DeepSimulationLive;
